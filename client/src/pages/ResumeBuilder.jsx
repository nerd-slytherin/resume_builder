...
const ResumeBuilder = () => {
  ...
  return (
    <div>
      <div className="max-w-7xl ms-auto px-4 py-6">
             ...
             <div className ='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
                ...
                <div className="flex items-center justify-between mb-6 border-b border-gray-300 py-1">
                  ...
                  <div className='flex items-center'>
                     ...
                     <button 
                        onClick={()=> setActiveSectionIndex((prevIndex)=> Math.min(prevIndex + 1, sections.length - 1))} className={`flex items-center gap-1 p-3 rounded-lg text-sm font-medium hover:bg-gray-50 transition-all ${activeSectionIndex === sections.length - 1  && 'opacity-50' }`} disabled={activeSectionIndex === sections.length - 1}>
